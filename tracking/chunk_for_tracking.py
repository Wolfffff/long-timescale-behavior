# Simple script for taking frame chunks from a video
...
parser.add_argument(
    "number_of_slices", type=int, default=20, nargs="?", help="number of slices"
)
...
def ranges(N, nb):
    step = N / nb
    return [
        "{}-{}".format(round(step * i), round(step * (i + 1) - 1)) for i in range(nb)
    ]
